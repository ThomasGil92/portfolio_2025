...
export function Contact() {
    return (
      <section id='contact' className='w-full mt-8 bg-background'>
        <div className='container px-4 md:px-6'>
          ...
          <div className='mt-8 max-w-3xl text-center text-muted mx-auto'><p className='max-w-[700px] text-muted-foreground md:text-xl'>
